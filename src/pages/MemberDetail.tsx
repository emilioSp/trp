...
function MemberDetail() {
	...
	const [iRatingChartData, setIRatingChartData] = useState<MemberChart | null>(null);
		...
		<div className="min-h-screen bg-gray-100 p-4">
			...
			<div className="bg-white rounded-lg shadow-lg p-6 mb-6">
				...
				<div className="grid grid-cols-2 md:grid-cols-5 gap-4">
					<div className={`p-4 rounded ${getClassNameForSR(memberInfo.className)}`}>
								...
								<tbody>
									{careerData.stats.map((stat, idx) => (
										...
										>
											...
											<td className="px-4 py-3 text-center text-sm text-gray-800">
												{stat.avg_start_position.toFixed(
													1,
												)}
											</td>
											<td className="px-4 py-3 text-center text-sm text-gray-800">
												{stat.avg_finish_position.toFixed(
													1,
												)}
											</td>
					...
					<div className="bg-white rounded-lg shadow-lg p-6 mb-6">
						...
						<div className="mt-4 p-4 bg-indigo-50 rounded">
							<p className="text-sm text-gray-600">
								...
								{iRatingChartData.data[iRatingChartData.data.length - 1]?.value.toLocaleString()}
							</p>
				...
				<div className="bg-white rounded-lg shadow-lg p-6">
					...
					{memberData.races.length === 0 ? (
						<p className="text-gray-600">
							No races found for this member.
						</p>
					) : (
						<div className="overflow-x-auto">
							<table className="w-full">
